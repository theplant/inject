...
func TestSignalService_StopBehavior(t *testing.T) {
	...
	// Error should be context.Canceled (because we cancelled the context)
	err = svc.Err()
...
// TestSignalService_RealSIGINT tests that SignalService actually responds to SIGINT
func TestSignalService_RealSIGINT(t *testing.T) {
	if testing.Short() {
